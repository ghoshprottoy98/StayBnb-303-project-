            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" autocomplete="nope" action ="/signup" class="register-form" id="register-form">
                            @csrf
                    ...
                    <div class="signup-image">
                        <a href="{{url('/')}}"><figure><img src="img/signup.png" alt="sing up image"></figure></a>
